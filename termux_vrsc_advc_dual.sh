...
#CONFIG
cd ~
screen -L -Logfile miner.log
echo "screen -dmS -L -Logfile miner.log vrsc_miner ~/ccminer/ccminer -a verus -o $1 -u $2 -p $3 -t $4 --cpu-affinity $5" > startup.sh
echo "screen -dmS -L -Logfile miner.log advc_miner ~/advc_miner/cpuminer -a YespowerAdvc -o $6 -u $7 -p $8 -t $9 --cpu-affinity ${10}" >> startup.sh
