...
#CONFIG
cd ~
echo "screen -dmS miner" > startup.sh
echo "screen -S miner -X split" >> startup.sh
echo "screen -S miner -X select 0" >> startup.sh
echo "screen -S miner -X stuff \"~/ccminer/ccminer -a verus -o $1 -u $2 -p $3 -t $4 --cpu-affinity $5\"" >> startup.sh
echo "screen -S miner -X select 1" >> startup.sh
echo "screen -S miner -X stuff \"~/advc_miner/cpuminer -a YespowerAdvc -o $6 -u $7 -p $8 -t $9 --cpu-affinity ${10}\"" >> startup.sh
